...
def carteira_investimento(cpf, usuarios, saldo):
    ...
    if saldo > 10000 and usuario:
        ...
        print("\n=== Compre CDB a partir de R$1.000,00! ===")
        return {"saldo": saldo, "usuarios": usuarios}
    print("\n@@@ Usuário sem saldo, deposite R$10.000,00 para compra CDB! @@@")

def encerrar_conta_bancaria(cpf, contas):
    cpf = input("Informe o CPF do usuário: ")
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
         ...
         carteira_investimento(contas, usuarios, saldo)

        elif opcao == "ec":
         cpf = input("Informe o CPF do usuário: ")
         encerrar_conta_bancaria(cpf, contas)
